        ...
        <div className="carousel-inner" >
          <div className="carousel-item active " >
            ...
            <div className="carousel-caption d-none d-md-block ">
                ...
                <div className="word-slider" style={{width:"600px" , position:"relative",bottom:"130px",right:"60px"}}>
                        <p  style={{fontSize:"60px"}}>Accesories For Pet</p>
                </div>

                <div className="word-slider " style={{width:"550px" , position:"relative",bottom:"130px",right:"25px"}}>
                ...
                <div className="word-slider " style={{width:"200px" , position:"relative",bottom:"120px",right:"60px"}}>
